#!/usr/bin/env python3
"""Run PF inference benchmark matrix on small IEEE cases (disk load in get).

Sample counts match gridfm-datakit pure-Julia matrix_config.jl (small scope).
...
CONFIG_DIR = SCRIPT_DIR / "configs/pf_from_disk_ieee"
OUTPUT_DIR = SCRIPT_DIR / "genco_pf_from_disk/ieee"
...
# (network, num_samples) from matrix_config.jl small scope
NETWORK_SPECS = [
    ("case14_ieee", 4_000_000),
    ("case30_ieee", 3_000_000),
    ("case57_ieee", 2_000_000),
    ("case118_ieee", 2_000_000),
]
