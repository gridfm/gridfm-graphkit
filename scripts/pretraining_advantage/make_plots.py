...
def plot_grouped(df: pd.DataFrame, output_path: Path) -> None:
    ...
    # -----------------------------
    # DC-PF (tab orange, DIFFERENT line style)
    # -----------------------------
    ax.axhline(
        dc_residual,
        linestyle="-.",
...
def main() -> None:
    ...
    output = args.output or (args.runs_dir / "scratch_vs_finetune_active_residuals.pdf")
